        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="flex flex-col justify-center">
                ...
                <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl">To access <a
                        class="text-green-600"><?= $name; ?> customer panel</a>,
                    ...
                    <form class="mt-8 space-y-6" method="post">
                        ...
                        <div class="relative">
                            <input type="text" name="license"
                                ...
                                placeholder=" " autocomplete="on" required />
                            <label for="license"
                                class="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[#09090d] px-2 peer-focus:px-2 peer-focus:text-green-600 peer-focus:text-green-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">License</label>
                        </div>
                        <button name="upgrade"
                            class="w-full px-5 py-3 text-base font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:ring-green-300 sm:w-full">Upgrade
                        </button>
                    </form>
                </div>
            </div>
